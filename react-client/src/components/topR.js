...
function TopRight({ deleteNote,  back2SideBar,  selectedNote }){
    ...
    return(
            <div className="topR">  
                ...
                <button className="deleteNote" onClick={ () => deleteNote(selectedNote.id) }><span className="material-icons">delete_outline</span></button>
            </div>
    );
}
